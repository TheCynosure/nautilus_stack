...
"""autogenerated by genpy from point_cloud_embedder/GetPointCloudEmbeddingRequest.msg. Do not edit."""
import sys
...
class GetPointCloudEmbeddingRequest(genpy.Message):
  _md5sum = "96cec5374164b3b3d1d7ef5d7628a7ed"
  _type = "point_cloud_embedder/GetPointCloudEmbeddingRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetPointCloudEmbeddingRequest, self).__init__(*args, **kwds)
...
def _get_struct_B2I():
    ...
    return _struct_B2I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from point_cloud_embedder/GetPointCloudEmbeddingResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetPointCloudEmbeddingResponse(genpy.Message):
  _md5sum = "b2fe64d0918b001fee3435866a0d2530"
  _type = "point_cloud_embedder/GetPointCloudEmbeddingResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float32[] embedding
"""
  __slots__ = ['embedding']
  _slot_types = ['float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetPointCloudEmbeddingResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.embedding))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.embedding = struct.unpack(pattern, str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.embedding.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.embedding = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
def _get_struct_I():
    global _struct_I
    return _struct_I
class GetPointCloudEmbedding(object):
  _type          = 'point_cloud_embedder/GetPointCloudEmbedding'
  _md5sum = 'a2c07223ab3a99859d0995f0e704a95c'
  _request_class  = GetPointCloudEmbeddingRequest
  _response_class = GetPointCloudEmbeddingResponse
